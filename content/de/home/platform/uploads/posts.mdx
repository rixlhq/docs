...
<Callout type="info">
  Feed posts require an existing feed. Learn about [creating feeds](/de/home/platform/dashboard/feeds/overview) if you haven't
  set one up yet.
</Callout>
...
- **`video_quality`** - For videos: "basic", "shorts", or "pro" (see [Quality Tiers](/de/home/platform/uploads/videos/quality-tiers) for details)
...
**[API Reference](/de/api)** - Complete feed and post API documentation with all available parameters.
