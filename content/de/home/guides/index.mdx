...
<Columns cols={3}>
  <Card title="React Integration" href="/de/sdk/media-react/getting-started/overview" icon="layers">
...
<Columns cols={3}>
  <Card title="React SDK Setup" href="/de/sdk/media-react/getting-started/overview" icon="layers">
...
<Callout type="tip" title="Need inspiration?">
  Explore our [Best Practices](/de/home/getting-started/best-practices) for performance tips, check out the [Platform
  Documentation](/de/home/platform) for comprehensive features, or dive into the [API Reference](/de/api) for detailed technical
  documentation.
</Callout>
```
