...
<Columns cols={3}>
  ...
  <Card title="Video Component" href="/de/sdk/video-component" icon="video">
...
<div className="mt-12">
  <Callout type="tip" title="Ready to stream?">
    ...
    Component Guide](/de/sdk/video-component) to add professional video players to your application. For custom workflows, explore our [API
