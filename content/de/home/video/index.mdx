...
<Columns cols={3}>
  <Card title="Upload Videos" href="/de/home/platform/uploads/videos-guide" icon="upload">
    Professional video transcoding with adaptive streaming and instant delivery.
  </Card>
  <Card title="Video Component" href="/de/sdk/media-react/video-component" icon="video">
...
<Columns cols={3}>
  <Card title="Upload Your First Video" href="/de/home/platform/uploads/videos-guide" icon="upload">
    See HLS streaming and adaptive quality in action with our dashboard.
  </Card>
  <Card title="React Integration" href="/de/sdk/media-react/video-component" icon="video">
...
<div className="mt-12">
  <Callout type="tip" title="Ready to stream?">
    Start with our [Video Upload Guide](/de/home/platform/uploads/videos-guide) to see HLS streaming in action, or jump into the [React
    Component Guide](/de/sdk/media-react/video-component) to add professional video players to your application. For custom workflows, explore our [API
