...
<Columns cols={3}>
  ...
  <Card title="React Component" href="/de/sdk/media-react/image-component" icon="layers">
...
<Columns cols={3}>
  ...
  <Card title="React Integration" href="/de/sdk/media-react/image-component" icon="layers">
...
<div className="mt-12">
  <Callout type="tip" title="Ready to see the difference?">
    ...
    Component Guide](/de/sdk/media-react/image-component) to add delivered images to your application. For custom workflows, explore our [API
