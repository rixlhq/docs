...
- Use [`useGlobalPlayerSettings()`](/de/sdk/media-react/hooks/use-global-player-settings) only when one control should intentionally fan out to every mounted player on the page.
