...
Need custom controls? Use `theme="hideUI"` and render your own controls as siblings, or use the legacy player-scope hooks documented in [Hooks](/de/sdk/media-react/hooks).
