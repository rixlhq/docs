...
<Callout type="info">
  Need custom controls instead of the built-in player UI? Use the public [Hooks](/de/sdk/hooks) inside a `<VideoPlayer>` scope. The player-scope hooks bind to the enclosing player scope, not directly to the Lit-backed `<Video>`.
</Callout>
...
- Learn about [Video Component](/de/sdk/video-component) properties and advanced features
- Explore [Hooks](/de/sdk/hooks) when you want custom controls or player state
- Explore [Image Component](/de/sdk/image-component) optimization options
- Browse [SDK Overview](/de/sdk/getting-started) for complete documentation
