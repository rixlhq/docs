...
For details on the event taxonomy and core helpers, see [Analytics Integration](/de/sdk/video-component/analytics-integration) and [Core API](/de/sdk/core-api).
