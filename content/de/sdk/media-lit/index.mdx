...
For details on the event taxonomy and core helpers, see [Analytics Integration](/de/sdk/media-react/video-component/analytics-integration) and [Core API](/de/sdk/media-core/core-api).
