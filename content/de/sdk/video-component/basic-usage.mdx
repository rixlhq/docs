...
<Callout type="tip">
    **See it in action:** Check out the [AutoPlay Background video](/de/sdk/examples/autoplay-background) for a complete background video autoplay implementation.
</Callout>
...
<Callout type="tip">
    **See it in action:** Check out the [Standard player video example](/de/sdk/examples/standard-player) for a complete standard video player implementation.
</Callout>
