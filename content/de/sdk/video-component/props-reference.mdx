...
<Callout type="warning">
  **Hover theme exception:** When `theme="hover"` is set, `autoPlay` is ignored. The video is paused by default and only plays when the user hovers over it. See the [Hover Preview](/de/sdk/examples/hover-preview) example for details.
</Callout>
