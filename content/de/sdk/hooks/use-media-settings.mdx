...
- Use [`useGlobalPlayerSettings()`](/de/sdk/hooks/use-global-player-settings) only when one control should intentionally fan out to every mounted player on the page.
