...
If you are building on top of the public `Video` component, prefer [`usePlayerProgress()`](/de/sdk/hooks/use-player-progress) — it binds to the enclosing player scope and needs no arguments.
