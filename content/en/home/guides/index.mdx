...
<Columns cols={3}>
  <Card title="React Integration" href="/en/sdk/media-react/getting-started/overview" icon="layers">
...
<Columns cols={3}>
  <Card title="React SDK Setup" href="/en/sdk/media-react/getting-started/overview" icon="layers">
