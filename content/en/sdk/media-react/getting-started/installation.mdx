---
title: "Installation"
description: "Install and configure RIXL Media SDK for React in your project"
---
...
<TabsContent value="npm">```bash npm install @rixl/media-react ```</TabsContent>

<TabsContent value="yarn">```bash yarn add @rixl/media-react ```</TabsContent>

<TabsContent value="pnpm">```bash pnpm add @rixl/media-react ```</TabsContent>

  <TabsContent value="bun">
    ```bash
    bun add @rixl/media-react
    ```
  </TabsContent>
</Tabs>
...
<Callout type="info">
  Need custom controls instead of the built-in player UI? Use the public [Hooks](/en/sdk/media-react/hooks) inside a `<VideoPlayer>` scope. The player-scope hooks bind to the enclosing player scope, not directly to the Lit-backed `<Video>`.
</Callout>
...
- Learn about [Video Component](/en/sdk/media-react/video-component) properties and advanced features
- Explore [Hooks](/en/sdk/media-react/hooks) when you want custom controls or player state
- Explore [Image Component](/en/sdk/media-react/image-component) optimization options
- Browse [SDK Overview](/en/sdk/media-react) for complete documentation
