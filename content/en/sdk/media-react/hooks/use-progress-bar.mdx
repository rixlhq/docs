...
If you are building on top of a `VideoPlayer` scope, prefer [`usePlayerProgress()`](/en/sdk/media-react/hooks/use-player-progress) — it binds to the enclosing player scope and needs no arguments.
