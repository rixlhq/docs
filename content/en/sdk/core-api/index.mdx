---
title: "Core API"
description: "Framework-agnostic API for fetching media, sending analytics, and managing context"
---
...
<Callout type="info">
  `postContentEvent` takes `BuildEventParams` and `buildVideoAnalyticsPayload` takes `BuildVideoAnalyticsPayloadParams`.
