...
| `limit`          | `number`                              | No       | `10`     | Posts to fetch per page                                           |
| `buffer`         | `number`                              | No       | `2`      | Posts to keep rendered off-screen                                 |
...
For details on the event taxonomy and core helpers, see [Analytics Integration](/en/sdk/video-component/analytics-integration) and [Core API](/en/sdk/core-api).
