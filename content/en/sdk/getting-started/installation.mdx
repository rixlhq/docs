...
<Callout type="info">
  Need custom controls instead of the built-in player UI? Use the public [Hooks](/en/sdk/hooks) inside a `<VideoPlayer>` scope. The player-scope hooks bind to the enclosing player scope, not directly to the Lit-backed `<Video>`.
</Callout>
