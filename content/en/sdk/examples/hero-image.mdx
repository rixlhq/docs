...
<div className="relative w-full h-screen">
  <Image id="landing-hero" alt="Landing page hero" className="w-full h-full object-cover" />
...
<section className="grid md:grid-cols-2 gap-0">
  <div className="relative h-[400px]">
    <Image id="feature-image" alt="Feature showcase" className="w-full h-full object-cover" />
  </div>
...
<div className="relative w-full h-[600px]">
  <Image id="split-hero" alt="Split hero background" className="w-full h-full object-cover" />
