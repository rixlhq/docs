...
<Callout type="info">
  <strong>Browser Autoplay:</strong> The SDK handles autoplay compliance automatically. For background videos like this,{" "}
  <code>muted=&#123;true&#125;</code> permanently disables audio and hides sound controls — which is the desired behavior when using{" "}
  <code>hideUI</code>.
</Callout>
